...
Ok now I have this function, but to next step, I want output should be structured.
"""
...
class UserTicket(BaseModel):
    ...
    contact: Literal["email", "phone_number", "direct_message"] = Field(
        description="Email or phone number or dirrect message"
    )
